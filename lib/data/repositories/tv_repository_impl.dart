...
import 'package:ditonton/data/datasources/tv_local_data_source.dart.dart';
...
class TvRepositoryImpl implements TvRepository {
  ...
  Future<Either<Failure, String>> saveTvWatchlist(TvDetail tv) async {
    try {
      final result = await localDataSource.insertTv(TvTable.fromEntity(tv));
      return Right(result);
  ...
  Future<Either<Failure, String>> removeTvWatchlist(TvDetail tv) async {
    try {
      final result = await localDataSource.removeTv(TvTable.fromEntity(tv));
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    }
  ...
  Future<Either<Failure, List<Tv>>> getWatchlistTv() async {
    final result = await localDataSource.getTvList();
